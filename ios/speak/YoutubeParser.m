...
RCT_REMAP_METHOD(obtainVideoFromLink,
                  youtubeID:(NSString *)youtubeID
                  resolver:(RCTPromiseResolveBlock)resolve
                  rejecter:(RCTPromiseRejectBlock)reject)
{
  NSDictionary *videos = [YoutubeParser h264videosWithYoutubeURL:[NSURL URLWithString:youtubeID]];

  resolve([videos objectForKey:@"medium"]);
}
